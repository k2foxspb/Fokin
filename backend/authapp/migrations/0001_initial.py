# Generated by Django 4.2.6 on 2023-11-12 05:12
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('username', models.CharField(error_messages={'Пользователь с таким именем уже существует'}, help_text='не более 35 символов. Только буквы, цифры и @/./+/-/_.', max_length=35, unique=True, validators=[django.contrib.auth.validators.ASCIIUsernameValidator()], verbose_name='Логин')),
                ...
                ('email', models.CharField(error_messages={'Пользователь с таким адресом электронной почты уже существует.'}, max_length=256, unique=True, verbose_name='адрес электронной почты')),
